...
!(function () {
 ...
 if(window.location.pathname.includes('/collections/sale') || window.location.pathname.includes('/collections/shop-all')) {
              ...
              },
              {
                ...
                value: function (t) {
                  t.target.getAttribute("data-turbolinks") &&
                    (this.activateSubNav(t.target), t.preventDefault());
                },
              },
              {
                ...
                r &&
                  ...
                  r.forEach(function (e, index) {
                    ...
                    d.innerHTML = a.innerHTML;
                      ...
                      var container = t.querySelector(".product-index--interface--swatch-list");
                      if (container) {
                    ...
                    if (
                      ...
                      v.setAttribute("data-product-id", r),
                        ...
                        1 == e.variants.length
                          ? v.setAttribute("data-variant-id", e.variants[0].id)
            ...
            },
            {
              ...
              value: function (t) {
                ...
                n && this.addVariantToCart(e, n),
                  ...
                  t.preventDefault();
                  t.stopPropagation();
                  window.location.href = `${t.target.closest(".product-index--item").querySelector(".product-index--link").getAttribute("href")}`
                }
              },
            },
            {
            ...
            (n = [
              {
                ...
                value: function () {
                  ...
                  document.querySelector('.product-form-id').value = this.productJson.variants[0].id
              ...
              },
              {
                ...
                value: function (t) {
                  var e = document.querySelector(
                    ...
                    n =
                      (document.querySelector(".klaviyo-back-in-stock--email"),
                      {
                        a: e.getAttribute("data-backinstock-a"),
                        email: e.getAttribute("data-backinstock-email"),
                        variant: e.getAttribute("data-backinstock-variant"),
                        product: e.getAttribute("data-backinstock-product"),
                        platform: "shopify",
                      }),
                    r = [];
                  for (var i in n)
                    n.hasOwnProperty(i) &&
                      r.push(
                        encodeURIComponent(i) + "=" + encodeURIComponent(n[i])
                      );
                  r = r.join("&");
                  var o = new XMLHttpRequest();
                  o.open(
              ...
              value: function () {
                ...
                return (
                  ...
                  Promise.all(e).then(() => {
                        ...
                        const swiper = new Swiper('.collection-section-swiper-container', {
                  loop: true,
                  navigation: {
                ...
                function isDesktop() {
                  return window.matchMedia("(min-width: 768px)").matches;
                   ...
                   function isMainProductPage() {
                        return document.querySelector('.shopify-section .product') !== null;
                      }
